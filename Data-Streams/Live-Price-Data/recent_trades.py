        ...
        while True:
            try:
                ...
                if usd_size > 14999:
                    ...
                    output = f"{stars} {trade_type} {display_symbol} {readable_trade_time} ${usd_size:,.0f} @ ${price:,.2f}"
...
async def main():
    ...
    tasks = []
    stream_url = f"{websocket_url_base}{symbols[0]}@aggTrade"
    tasks.append(binance_trade_stream(stream_url, symbols[0], filename))
